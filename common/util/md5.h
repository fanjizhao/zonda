#ifndef ZONDA_COMMON_UTIL_MD5_H_
#define ZONDA_COMMON_UTIL_MD5_H_
...
namespace common
{
	...
	inline std::string digestToString(const char* digest,int len ){
        static const char * letters = "0123456789abcdef";
        std::stringstream ss;
        for ( int i=0; i<len; i++){
            unsigned char c = digest[i];
...
#endif //ZONDA_COMMON_UTIL_MD5_H_
